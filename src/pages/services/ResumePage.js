...
const ResumePage = () => (
  ...
  >
    ...
    >
      {/* Right - Image */}
      <Image
        src="/assets/images/cv_eval_service.svg"
      ...
      >
        ...
        <Text fontSize="lg" mb={6}>
          Our resume evaluation tool is fully aligned with Antonine University's CCD department standards,
      ...
      <HStack spacing={10} justify="center" flexWrap="wrap">
        ...
        <VStack spacing={4}>
          ...
          <Text fontSize="sm" color="gray.600" maxW="150px">
            Upload your current resume to start the evaluation.
          </Text>
        </VStack>
        ...
        <VStack spacing={4}>
          ...
          <Text fontSize="sm" color="gray.600" maxW="150px">
            System checks CV against professional standards.
          </Text>
        </VStack>
        ...
        <VStack spacing={4}>
          ...
          <Text fontSize="sm" color="gray.600" maxW="150px">
            Receive feedback and improve your resume instantly.
          </Text>
        </VStack>
      </HStack>
    </Box>
    ...
    <Text fontSize="lg" mb={6}>
        Take the first step towards a professional CV aligned with international standards.
    </Text>
    <Button
        as={RouterLink}
        to="/resume-evaluation/try"
